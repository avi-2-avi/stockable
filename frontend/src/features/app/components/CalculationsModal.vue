        ...
        <div class="bg-base rounded-lg shadow-lg p-6 mx-4 container overflow-y-auto max-h-[90vh]">
            ...
            <div class="text-sm space-y-4">
                ...
                <table class="w-full border mt-2 text-sm">
                    ...
                    <tbody>
                        <tr>
                            <td class="border p-2">Strong-Buy</td>
                        ...
                        <tr>
                            <td class="border p-2">Buy / Overweight</td>
                            <td class="border p-2">3</td>
                            <td class="border p-2">3</td>
                            <td class="border p-2">-2</td>
                            <td class="border p-2">-3</td>
                        ...
                        <tr>
                            <td class="border p-2">Neutral / Hold</td>
                            <td class="border p-2">2</td>
                            <td class="border p-2">2</td>
                        ...
                        <tr>
                            <td class="border p-2">Sell / Underperform</td>
                            <td class="border p-2">4</td>
                            <td class="border p-2">3</td>
                            <td class="border p-2">1</td>
                            <td class="border p-2">-1</td>
                        ...
                        <tr>
                            <td class="border p-2">Sector Perform</td>
                            <td class="border p-2">2</td>
                            <td class="border p-2">2</td>
                            <td class="border p-2">-1</td>
                            <td class="border p-2">-2</td>
                        ...
                        <tr>
                            <td class="border p-2">Market Perform</td>
                            <td class="border p-2">3</td>
                            <td class="border p-2">2</td>
                            <td class="border p-2">-1</td>
                            <td class="border p-2">-2</td>
